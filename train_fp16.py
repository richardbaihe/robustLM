...
def get_args():
    ...
    parser.add_argument('--fp32_tokentypes', action='store_true',
                       help='embedding token types in fp32')
    parser.add_argument('--fp32_allreduce', action='store_true',
    ...
    if os.path.exists(os.path.join(args.restart_dir, 'optimizer.pt')):
        with open(os.path.join(args.restart_dir, 'optimizer.pt'), 'rb') as f:
            ...
            if 'loss_scaler' in opt_state_dict.keys() and not args.fp16:
                opt_state_dict = opt_state_dict['optimizer_state_dict']
